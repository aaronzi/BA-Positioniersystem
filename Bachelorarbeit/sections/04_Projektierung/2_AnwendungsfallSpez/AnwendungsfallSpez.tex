...
\begin{longtable}[c]{| p{0.28\linewidth} | p{0.32\linewidth} | p{0.32\linewidth} |}
    \hline
    \textbf{Name}                   &   \multicolumn{2}{| l |}{Positionieren}                                      \\ \hline
    \textbf{Akteur}                 &   \multicolumn{2}{| l |}{Aufnahmeposition}                                            \\ \hline
    \textbf{Auslösendes Ereignis}   &   \multicolumn{2}{| l |}{Auswahl des Automatikmodus wurde bestätigt}    \\ \hline
    \textbf{Kurzbeschreibung}       &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{Ein Transportobjekt wird mit dem Greifer von der Aufnahmeposition angehoben. Anschließend führt das System seine eigentlichen Positionieraufgaben durch (\zB Fahren einer hindernisausweichenden Trajektorie). Auf der Ablageposition wird das Transportobjekt wieder losgelassen.}                                                                                                    \\ \hline
    \textbf{Vorbedingungen}         &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=*]
                                                                    \item Anlage wurde eingeschaltet
                                                                    \item der Automatikmodus wurde ausgewählt
                                                                    \item Starbedingung des Automatikprogrammes erfüllt (\zB Aufnahmeposition ist mit Transportobjekt bestückt)
                                                                \end{itemize}}       \\ \hline
    \multirow{5}{=}{\textbf{Schritte}}  &   \textbf{Intention der Systemumgebung}   &   \textbf{Reaktion des Systems}   \\ \cline{2-3}
                                                    &   Positioniereinheit soll vollautomatisch Transportgüter von der Aufnahmeposition zur Ablageposition befördert    &   Laboranlage beginnt Objekte von der Aufnahmeposition zu greifen und zu transportieren   \\ \cline{2-3}
                                                    &   Not-Halt wird aufgrund einer Gafahrensituation ausgelöst   &   Die Laboranlage bremst bis zum Stillstand ab und erwartet eine Bestätigung, dass die Gefahren- \bzw Fehlersituation beseitigt ist   \\ \cline{2-3}
                                                    &   Bewegungsgeschwindigkeit des Systems wird angepasst   &   Die Achsen des Systems bewegen sich entsprechend der analogen Nutzereingabe schneller \bzw langsamer \\ \cline{2-3}
    ...
    \textbf{Verfügbarkeit}          &   \multicolumn{2}{| l |}{maximal ein Systemausfall in 10.000 \si{h}}                        \\ \hline
    \textbf{Kommentare/Fragen}      &   \multicolumn{2}{| l |}{-\xspace -\xspace -}                                         \\ \hline
    
    \caption[Systemprozess - Positionieren]{Anwendungsfallbeschreibung - Systemprozess: Positionieren im Automatikmodus}
...
\begin{longtable}[c]{| p{0.28\linewidth} | p{0.32\linewidth} | p{0.32\linewidth} |}
    ...
    \textbf{Kurzbeschreibung}       &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{Die dem betätigten Taster zugehörige Achse bewegt sich entsprechend der angezeigten Richtung auf diesem Taster. Wird einer der dem Greifer zugehörigen Taster gedrückt, schwenkt der Greifarm um \bzw der Greifer öffnet/schließt}                                                                                                    \\ \hline
    \textbf{Vorbedingungen}         &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=*]
                                                                    \item Anlage wurde eingeschaltet
                                                                    \item der Handmodus wurde ausgewählt
                                                                    \item mindestens einer der vier Richtungstaster auf dem vierfach Drucktaster wird gedrückt oder einer der beiden dem Greifer zugehörigen Taster
                                                                \end{itemize}}       \\ \hline
    \multirow{8}{=}{\textbf{Schritte}}  &   \textbf{Intention der Systemumgebung}   &   \textbf{Reaktion des Systems}   \\ \cline{2-3}
                                                    &   System soll in horizontaler Richtung manuelle Positionieraufgaben durchführen   &   Das Positioniersystem erwartet Tastereingabe, die zum Joggen der x-Achse führt \\ \cline{2-3}
                                                    &   System soll in vertikaler Richtung manuelle Positionieraufgaben durchführen   &   Das Positioniersystem erwartet Tastereingabe, die zum Joggen der z-Achse führt \\ \cline{2-3}
                                                    &   Greifarm soll um 180° geschwenkt werden   &   Das Positioniersystem erwartet Tastereingabe, die zum Schwenken des Greifarms führt \\ \cline{2-3}
                                                    &   TRansportobjekt soll gegriffen \bzw losgelassen werden  &   Das Positioniersystem erwartet Tastereingabe, die zum Öffnen \bzw Schließen des Greifers führt \\ \cline{2-3}
                                                    &   Not-Halt wird aufgrund einer Gefahrensituation ausgelöst    &   Die Laboranlage bremst bis zum Stillstand ab und erwartet eine Bestätigung, dass die Gefahren- \bzw Fehlersituation beseitigt ist   \\ \cline{2-3}
                                                    &   Bewegungsgeschwindigkeit des Systems wird angepasst   &   Die Achsen des Systems bewegen sich entsprechend der analogen Nutzereingabe schneller \bzw langsamer \\ \cline{2-3}
    ...
    \caption[Systemprozess - manuelle Funktionsausführung]{Anwendungsfallbeschreibung - Systemprozess: manuelle Funktionsausführung im Handmodus}
...
\begin{longtable}[c]{| p{0.28\linewidth} | p{0.32\linewidth} | p{0.32\linewidth} |}
    ...
    \textbf{Kurzbeschreibung}       &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{Über eine Ethernetschnittstelle ist das Positioniersystem mit dem Labornetzwerk verbunden. Von Geräten aus demselben Netzwerk kann auf das System zugegriffen werden \bzw Änderungen an dessen Programmcode vorgenommen werden.}                                                                                                    \\ \hline
    \textbf{Vorbedingungen}         &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=*]
                                                                ...
                                                                \end{itemize}}       \\ \hline
    \multirow{3}{=}{\textbf{Schritte}}  &   \textbf{Intention der Systemumgebung}   &   \textbf{Reaktion des Systems}   \\ \cline{2-3}
                                                    &   Es soll neuer Programmcode durch den Prozessentwickler auf die Steuerung übertragen werden   &   In Maschinencode übersetzter Programmcode wird über die Ethernetschnittstelle zur Steuerung übertragen  \\ \cline{2-3}
                                                    &   Neues Programm soll auf der Steuerung ausgeführt werden   &   System führt einen Kaltstart  \\ \hline
    \textbf{Ausnahmefälle}          &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=*]
...
\begin{longtable}[c]{| p{0.28\linewidth} | p{0.32\linewidth} | p{0.32\linewidth} |}
    ...
    \multirow{3}{=}{\textbf{Schritte}}  &   \textbf{Intention der Systemumgebung}   &   \textbf{Reaktion des Systems}   \\ \cline{2-3}
                                                    &   Es sollen Prozessdaten über die OPC-Schnittstelle ausgelesen werden   &   Die Steuerung stellt Daten via OPC UA Schnittstelle bereit (ein OPC-Client kann diese entgegennehmen)  \\ \cline{2-3}
                                                    &   Prozessdaten sollen extern weiterverarbeitet werden   &   System kommuniziert mit \zB dem AR Server oder einer Verwaltungsschale, welche als OPC Client Daten entgegennehmen  \\ \hline
    \textbf{Ausnahmefälle}          &   \multicolumn{2}{|p{\dimexpr0.64\linewidth+4\tabcolsep}|}{\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=*]
                                            \item Labornetzwerk ist ausgefallen oder verhindert die Kommunikation
                                            \item Defektbedingte Abschaltung der Anlage
                                        \end{itemize}}                                                                  \\ \hline
