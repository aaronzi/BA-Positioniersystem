...
\begin{longtable}[C]{| R{0.1\linewidth} | R{0.62\linewidth} | R{0.2\linewidth} | }
    ...
    7               &   Addressbereiche des \acs{slc} wurden für den Datenaustausch mit dem \acs{lmc} Freigegeben (\textit{LMC2SLCNumberOfBOOLs})   &   bestanden           \\ \hline
...
\begin{longtable}[C]{| R{0.1\linewidth} | R{0.62\linewidth} | R{0.2\linewidth} | }
    ...
    4               &   Bestätigung der Auswahl führt zum Anlagen der Aufgabe in der \acs{gui}                                                      &   bestanden           \\ \hline
    5               &   Tasten der Vier-Wege-Richtungsgebers führt zu Bewegungen der jeweiligen Achse                                               &   nicht bestanden     \\ \hline
